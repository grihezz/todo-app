...
func (r *TodoItemPostgres) Create(listId int, item Resrik.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoItemPostgres) GetAll(userId, listId int) ([]Resrik.TodoItem, error) {
	var items []Resrik.TodoItem
...
func (r *TodoItemPostgres) GetByItemId(userId int, itemId int) ([]Resrik.TodoItem, error) {
	var item []Resrik.TodoItem
...
func (r *TodoItemPostgres) Update(userId, itemId int, input Resrik.UpdateInputItem) error {
